...
const FeatureCard = ({ icon: Icon, title, description, delay }: { icon: any, title: string, description: string, delay: number }) => (
  <motion.div 
    ...
    className="liquid-glass-blue p-8 rounded-[2rem] flex flex-col gap-4 group cursor-pointer hover:bg-blue-500/10 transition-all duration-500 focus-within:ring-2 focus-within:ring-blue-500 focus-within:ring-offset-2 outline-none"
    tabIndex={0}
  >
  ...
  >
    ...
    <div className="flex items-center justify-between mt-auto">
      ...
      <div className="flex gap-2 opacity-0 group-hover:opacity-100 transition-all duration-300 translate-y-2 group-hover:translate-y-0">
        <button className="p-2 rounded-full bg-blue-50 text-blue-600 hover:bg-blue-600 hover:text-white focus:ring-2 focus:ring-blue-500 outline-none transition-all">
          <Facebook size={12} />
        </button>
        <button className="p-2 rounded-full bg-blue-50 text-blue-600 hover:bg-blue-600 hover:text-white focus:ring-2 focus:ring-blue-500 outline-none transition-all">
          <Twitter size={12} />
...
const TransformationCard = ({ name, result, duration, beforeImg, afterImg, delay }: { name: string, result: string, duration: string, beforeImg: string, afterImg: string, delay: number, key?: any }) => (
  ...
  >
    ...
    <div className="absolute top-8 left-8 flex flex-col gap-2">
      <div className="px-4 py-1.5 liquid-glass-blue border-white/50 rounded-full text-[10px] font-black text-blue-600 uppercase tracking-widest self-start">
        {duration}
      </div>
    </div>
    ...
    <div className="absolute top-8 right-8 flex flex-col gap-3 translate-x-12 opacity-0 group-hover:translate-x-0 group-hover:opacity-100 transition-all duration-500">
      <button className="w-10 h-10 rounded-2xl liquid-glass flex items-center justify-center text-blue-300 hover:bg-blue-500 transition-colors">
        <Facebook size={18} />
      </button>
      <button className="w-10 h-10 rounded-2xl liquid-glass flex items-center justify-center text-blue-300 hover:bg-blue-500 transition-colors">
        <Twitter size={18} />
    ...
    <div className="absolute inset-x-8 bottom-8 flex flex-col gap-4">
      <div className="flex justify-between items-end">
        <div>
          <h4 className="text-white font-black text-3xl tracking-tighter uppercase leading-none mb-1">{name}</h4>
          <p className="text-blue-300 text-[10px] font-black tracking-[0.2em] uppercase opacity-0 group-hover:opacity-100 transition-opacity duration-500">ELITE PERFORMANCE</p>
        </div>
        <div className="text-right">
          <p className="text-white/40 text-[9px] font-black uppercase tracking-widest mb-1">FINAL STATS</p>
  ...
  >
    <div className="aspect-video overflow-hidden relative">
      ...
      <div className="absolute top-4 left-4">
        <span className="px-3 py-1 bg-white/90 backdrop-blur-md rounded-full text-[9px] font-black text-blue-600 uppercase tracking-widest">{category}</span>
      </div>
    </div>
    <div className="p-8">
      <div className="flex items-center gap-2 text-[9px] font-black text-slate-400 uppercase tracking-[0.2em] mb-4">
      ...
      <button className="inline-flex items-center gap-2 text-[10px] font-black text-blue-600 uppercase tracking-[0.2em] group-hover:translate-x-2 transition-transform outline-none focus-visible:ring-2 focus-visible:ring-blue-500 rounded-lg pr-4">
  ...
  return (
    <div className="border-b border-slate-100 last:border-0">
      <button 
        ...
        className="w-full py-6 flex justify-between items-center text-left transition-all group focus:outline-none focus-visible:text-blue-600 focus-visible:bg-slate-50/50 px-4 -mx-4 rounded-xl"
      ...
      >
        ...
        >
          ...
          <div className="space-y-4">
            ...
            <button 
              className="w-full flex items-center justify-center gap-3 bg-[#1877F2] text-white font-bold py-4 rounded-xl hover:bg-[#166fe5] transition-all active:scale-[0.98] shadow-md shadow-blue-600/10"
            >
          ...
          >
            ...
            {step === 1 ? (
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <input 
                      required
                      type="text" 
                      className="w-full bg-slate-50 border border-slate-100 rounded-2xl px-6 py-4 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all font-bold text-slate-800 placeholder:text-slate-300"
                ...
                <div className="space-y-2">
                  <label className="text-[10px] font-black tracking-widest uppercase text-slate-400 pl-2">Phone Number</label>
                  <input 
                    required
                    type="tel" 
                    className="w-full bg-slate-50 border border-slate-100 rounded-2xl px-6 py-4 focus:outline-none focus:border-blue-500 transition-colors font-bold text-slate-800"
                    placeholder="+254..."
                  />
                </div>
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    <label className="text-[10px] font-black tracking-widest uppercase text-slate-400 pl-2">Preferred Date</label>
                    <input 
                      required
                      type="date" 
                      className="w-full bg-slate-50 border border-slate-100 rounded-2xl px-6 py-4 focus:outline-none focus:border-blue-500 transition-colors font-bold text-slate-800"
                  ...
                  <div className="space-y-2">
                    <label className="text-[10px] font-black tracking-widest uppercase text-slate-400 pl-2">Preferred Time</label>
                    <input 
                      required
                      type="time" 
                      className="w-full bg-slate-50 border border-slate-100 rounded-2xl px-6 py-4 focus:outline-none focus:border-blue-500 transition-colors font-bold text-slate-800"
                ...
                <button type="submit" className="w-full bg-blue-600 text-white font-black py-5 rounded-2xl shadow-xl shadow-blue-600/20 hover:bg-blue-700 transition-all uppercase tracking-widest">
              ...
              <div className="text-center py-12">
                ...
                <h3 className="text-3xl font-black tracking-tighter text-slate-900 mb-4 uppercase">Request Logged.</h3>
...
const PricingCard = ({ tier, delay }: { tier: typeof pricingTiers[0], delay: number, key?: any }) => (
  ...
  >
    ...
    <h3 className="text-xl font-black tracking-tighter uppercase mb-2">{tier.name}</h3>
    <div className="flex items-end gap-1 mb-6">
      <span className="text-sm font-black opacity-60 mb-2 uppercase tracking-widest leading-none">KES</span>
    ...
    <button className={`w-full py-5 rounded-2xl font-black text-sm uppercase tracking-widest transition-all ${tier.highlight ? 'bg-white text-blue-600 hover:bg-blue-50' : 'bg-blue-600 text-white hover:bg-blue-700 shadow-lg shadow-blue-600/20'}`}>
      {tier.cta}
    </button>
  </motion.div>
);
        ...
        <div>
          ...
          <div className="space-y-8">
            <div className="flex items-center gap-5">
              ...
              <div>
                <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1">Pulse Base</p>
            ...
            <div className="flex items-center gap-5">
              ...
              <div>
                <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1">Direct Connect</p>
  ...
  return (
    <div className="relative min-h-screen selection:bg-blue-100 selection:text-blue-600" ref={containerRef}>
        ...
        <div className="liquid-glass px-8 py-3 rounded-2xl flex items-center justify-between shadow-lg shadow-blue-500/5">
          ...
          <div className="hidden md:flex items-center gap-8">
            {['Programs', 'Transformation', 'Pricing', 'About', 'Contact'].map((item) => (
              <a 
                ...
                className="text-[10px] font-black text-slate-500 hover:text-blue-600 focus:text-blue-600 transition-colors uppercase tracking-[0.2em] outline-none"
              >
                {item}
              </a>
            ))}
          ...
          <div className="flex items-center gap-4">
            ...
            <button 
              ...
              className="hidden md:block text-xs font-black bg-blue-600 text-white px-6 py-2.5 rounded-full hover:bg-blue-700 transition-all shadow-md shadow-blue-600/20 active:scale-95"
            >
              BOOK CONSULT
            </button>
          ...
          >
            <div className="flex flex-col gap-6">
              ...
              <button 
                ...
                className="bg-blue-600 text-white px-8 py-5 rounded-2xl font-black text-lg shadow-xl shadow-blue-600/20"
              >
                Book Consult
              </button>
              <button 
                ...
                className="text-slate-500 font-black tracking-widest text-[10px] uppercase py-4"
              >
                Sign In to Portal
              </button>
            </div>
      ...
      <main className="max-w-7xl mx-auto px-6 pt-40 pb-20">
        ...
        <div className="relative mb-40">
          ...
          >
            ...
            <motion.button 
                ...
                whileTap={{ scale: 0.95 }}
                onClick={() => setIsBookingModalOpen(true)}
                className="bg-blue-600 text-white px-12 py-6 rounded-2xl font-black flex items-center justify-center gap-4 transition-all shadow-[0_20px_40px_rgba(37,99,235,0.3)] hover:bg-blue-700 focus:ring-4 focus:ring-blue-500/20 outline-none"
              >
          ...
          >
            <div className="liquid-glass p-8 rounded-[3rem] flex flex-col gap-8 shadow-2xl shadow-blue-900/5 group-hover:rotate-0 transition-transform duration-700">
              <div className="flex justify-between items-start">
                ...
                <div className="text-right">
                  <p className="text-[10px] font-black text-blue-500 uppercase tracking-[0.2em]">Metabolism</p>
              ...
              <div className="flex items-center gap-3">
                ...
                <p className="text-[10px] font-black tracking-[0.15em] text-slate-800">DR. KENNETH R. <span className="text-blue-500 opacity-50">— SURGEON</span></p>
              </div>
            </div>
          </motion.div>
        </div>
        ...
        <div className="mb-40" id="programs">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <FeatureCard 
              ...
              description="Precision weight training logic merging high-tension conditioning with elite biometric tracking."
              delay={0.1}
            />
            <FeatureCard 
              icon={FruitIcon}
              title="Bio-Nutrition"
              description="Data-driven nutritional blueprints optimized for Rift Valley climate and enzymatic efficiency."
              delay={0.2}
            />
            <FeatureCard 
              icon={Clock}
              title="Elite Recovery"
              description="Neuro-muscular restoration strategies to compress regeneration cycles and peak faster."
              delay={0.3}
            />
          </div>
        </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 h-[600px]">
            ...
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-blue-900/60 to-transparent p-10 flex flex-col justify-end opacity-0 group-hover:opacity-100 transition-opacity">
                <span className="text-white font-black text-2xl tracking-tighter uppercase">Power Zone</span>
              </div>
            </motion.div>
            <motion.div 
              whileHover={{ scale: 0.98 }}
            ...
            >
              ...
              <div className="absolute bottom-6 right-8 liquid-glass px-4 py-2 rounded-xl text-[10px] font-black text-blue-600 uppercase tracking-widest border-blue-200">Rift Valley Views</div>
            </motion.div>
          </div>
        </section>
            ...
            <div className="relative z-10">
              <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-16 gap-8">
                <div className="max-w-xl">
                  <div className="inline-flex items-center gap-2 px-3 py-1 bg-blue-600 text-[9px] font-black tracking-widest uppercase text-white mb-6 rounded-full shadow-lg shadow-blue-600/20">
                ...
                <div className="flex items-center gap-4 liquid-glass p-4 rounded-3xl border-slate-100">
                  ...
                  <div>
                    <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Active Client</p>
              ...
              <div className="grid lg:grid-cols-3 gap-8">
                <div className="lg:col-span-2 space-y-8">
                  <div className="liquid-glass border-slate-100 p-8 rounded-[3rem] h-[450px]">
                    <div className="flex justify-between items-center mb-8">
                      <div>
                        <h4 className="font-black text-slate-800 uppercase tracking-tight">Mass Velocity</h4>
                        <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">6 Month Weight Transformation</p>
                      </div>
                      <div className="flex gap-2">
                        <div className="flex items-center gap-1.5">
                          <div className="w-2 h-2 rounded-full bg-blue-600" />
                          <span className="text-[9px] font-black text-slate-500 uppercase">Weight</span>
                        </div>
                        <div className="flex items-center gap-1.5">
                          <div className="w-2 h-2 rounded-full bg-indigo-300" />
                          <span className="text-[9px] font-black text-slate-500 uppercase">Fat %</span>
                        </div>
                      </div>
                    </div>
                ...
                <div className="space-y-8">
                  <div className="liquid-glass border-slate-100 p-8 rounded-[3rem] text-center">
                    ...
                    <h4 className="font-black text-slate-800 uppercase tracking-tight mb-2">Performance Peak</h4>
                    <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-8">Overall Capability Score</p>
                    ...
                    <div className="relative inline-flex items-center justify-center mb-6">
                      ...
                      <div className="absolute flex flex-col items-center">
                        ...
                        <span className="text-[10px] font-black text-blue-500 uppercase tracking-widest">RANK A+</span>
                      </div>
                    </div>
                  ...
                  <div className="liquid-glass-blue border-blue-200/50 p-8 rounded-[3rem]">
                    <h4 className="font-black text-slate-800 uppercase tracking-tight text-sm mb-6 flex items-center gap-2">
        ...
        <section className="mb-40" id="transformation">
          <div className="flex flex-col md:flex-row justify-between items-center mb-16 gap-6">
            <div>
              <div className="inline-flex items-center gap-2 px-3 py-1 bg-blue-50 text-[9px] font-black tracking-widest uppercase text-blue-600 mb-4 rounded-full border border-blue-100">
        ...
        <section className="mb-40">
          <div className="text-center mb-16">
            <h2 className="text-5xl md:text-[5.5rem] font-black tracking-tighter text-slate-900 leading-none uppercase">The Mr Man Effect.</h2>
            <p className="text-slate-500 font-bold uppercase tracking-[0.3em] text-[10px] mt-6">Voices of the Transformation</p>
          </div>
          <div className="grid md:grid-cols-3 gap-8">
            ...
            >
              <div className="aspect-[4/5] rounded-3xl overflow-hidden shadow-2xl relative group">
                ...
                <div className="absolute bottom-10 left-10 text-white">
                  <p className="text-[10px] font-black tracking-[0.3em] uppercase mb-2">Lead Performance Engineer</p>
                  <h3 className="text-4xl font-black tracking-tighter uppercase">Mr Man.</h3>
                </div>
              </div>
              {/* Floating Stat */}
              <div className="absolute -right-8 top-1/4 liquid-glass p-6 rounded-3xl shadow-2xl border-white/50 max-w-[180px] hidden md:block">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <span className="text-[9px] font-black uppercase text-slate-400">Philosophy</span>
                </div>
            ...
            >
              ...
              <div className="mt-12 grid grid-cols-2 gap-8">
                <div>
                  ...
                  <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Clinical Research</p>
                </div>
                <div>
                  <h4 className="font-black text-blue-600 text-3xl tracking-tighter mb-1">500+</h4>
                  <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Elite Evolutions</p>
                </div>
              </div>
          ...
          <div className="bg-slate-900 rounded-3xl p-12 lg:p-20 relative overflow-hidden">
            <div className="relative z-10 grid lg:grid-cols-2 gap-16 items-center">
              <div>
                ...
                <h2 className="text-4xl md:text-6xl font-black tracking-tighter mb-8 leading-[0.9] text-white uppercase">
                ...
                {[
                  ...
                  >
                    ...
                    <div className="absolute bottom-6 left-6">
                      <p className="text-[10px] font-black text-blue-400 uppercase tracking-widest mb-1">STORY</p>
      ...
      <footer className="w-full mt-20 pt-32 pb-20 bg-slate-900 overflow-hidden relative shadow-2xl">
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-20 mb-24 relative z-10">
          <div className="space-y-8">
            <div className="flex items-center gap-3">
              ...
              <span className="font-black tracking-tighter text-3xl uppercase text-white">MR MAN.</span>
            </div>
            ...
            <div className="flex gap-4">
              {[Facebook, Twitter, Share2].map((Icon, i) => (
                <button key={i} className="w-10 h-10 rounded-xl bg-white/5 flex items-center justify-center text-slate-400 hover:text-white hover:bg-blue-600 transition-all">
                  <Icon size={18} />
                </button>
              ))}
            </div>
          ...
          <div className="space-y-6">
            <h4 className="text-blue-500 font-black text-[10px] tracking-[0.3em] uppercase">Navigation</h4>
            <div className="flex flex-col gap-4 text-sm font-bold text-slate-300">
              {['Programs', 'Transformations', 'Studio'].map(item => (
                <a key={item} href={`#${item.toLowerCase()}`} className="hover:text-blue-500 transition-all inline-flex items-center gap-2 group">
          ...
          <div className="space-y-6">
            <h4 className="text-blue-500 font-black text-[10px] tracking-[0.3em] uppercase">Contact Base</h4>
            <div className="space-y-4">
          ...
          <div className="space-y-6">
            <h4 className="text-blue-500 font-black text-[10px] tracking-[0.3em] uppercase">Intel Drop</h4>
            <p className="text-xs text-slate-500 font-medium">Get the latest performance data and studio updates.</p>
            <div className="relative group">
              <input 
                type="email" 
                placeholder="EMAIL ADDRESS" 
                className="w-full bg-white/5 border border-white/10 rounded-2xl px-6 py-4 text-[10px] font-black tracking-widest text-white focus:outline-none focus:border-blue-500/50 transition-all"
              />
              <button className="absolute right-2 top-2 bottom-2 bg-blue-600 text-white px-4 rounded-xl hover:bg-blue-500 transition-colors">
        ...
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center pt-12 border-t border-white/5 gap-6 text-[10px] font-black tracking-[0.3em] text-slate-500 uppercase relative z-10">
